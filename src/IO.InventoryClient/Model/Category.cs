...
namespace IO.InventoryClient.Model
{
    ...
    public partial class Category :  IEquatable<Category>
    {
        ...
        /// <param name="Parent">ID of parent element. Top level categories are set to root..</param>
        public Category(string Name = null, string Id = null, string Parent = null)
        {
            this.Name = Name;
            this.Id = Id;
            this.Parent = Parent;
        ...
        /// </summary>
        /// <value>ID of parent element. Top level categories are set to root.</value>
